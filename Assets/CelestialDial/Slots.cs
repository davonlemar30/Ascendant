...
namespace Ascendant.CelestialDial
{
    ...
    public static class Slots
    {
        ...
        public static readonly ArtSlot[] Art =
        {
            ...
            new ArtSlot("caspar", 44, 76, 256, "Caspar standing in the Atrium"),
            new ArtSlot("keeper-idle", 20, 44, 128, "the Keeper standing; faces the way it last walked"),
            new ArtSlot("keeper-walk", 20, 44, 128, "the Keeper mid-step; alternates with idle every step while walking"),
            ...
            new ArtSlot("journal-contents", 360, 800, 2048, "the journal's contents page with ruled entry rows"),
            new ArtSlot("journal-ribbon", 12, 90, 256, "the journal's silk ribbon bookmark, cropped to evidence length"),
            new ArtSlot("journal-plate", 96, 28, 256, "an engraved brass fact plate on a sign page"),
            new ArtSlot("sign-aries", 200, 200, 512, "the Aries sign illustration on its journal page"),
            new ArtSlot("sign-taurus", 200, 200, 512, "the Taurus sign illustration on its journal page"),
            new ArtSlot("sign-gemini", 200, 200, 512, "the Gemini sign illustration on its journal page"),
            new ArtSlot("sign-cancer", 200, 200, 512, "the Cancer sign illustration on its journal page"),
            new ArtSlot("sign-leo", 200, 200, 512, "the Leo sign illustration on its journal page"),
            new ArtSlot("sign-virgo", 200, 200, 512, "the Virgo sign illustration on its journal page"),
            new ArtSlot("sign-libra", 200, 200, 512, "the Libra sign illustration on its journal page"),
            new ArtSlot("sign-scorpio", 200, 200, 512, "the Scorpio sign illustration on its journal page"),
            new ArtSlot("sign-sagittarius", 200, 200, 512, "the Sagittarius sign illustration on its journal page"),
            new ArtSlot("sign-capricorn", 200, 200, 512, "the Capricorn sign illustration on its journal page"),
            new ArtSlot("sign-aquarius", 200, 200, 512, "the Aquarius sign illustration on its journal page"),
            new ArtSlot("sign-pisces", 200, 200, 512, "the Pisces sign illustration on its journal page"),
            ...
            new ArtSlot("door-open", 70, 100, 512, "an open doorway: the Wing's and the Chamber's in the Atrium, the doorways back (40 x 60 in the Chamber)"),
            new ArtSlot("door-sealed", 70, 100, 512, "the sealed door on the Atrium's left"),
