...
namespace Ascendant.Build
{
    ...
    public static class GreyboxValidation
    {
        ...
        public static void Run()
        {
            ...
            cflow.EnterWing();Check(cflow.LeaveWing() && cflow.AtriumStage==5,"three Keys: Stage 5");cflow.MarkKey4();cflow.EnterWing();Check(cflow.LeaveWing() && cflow.AtriumStage==6 && cflow.Keys==4,"Key 4 and one more return take the Atrium to Stage 6");
