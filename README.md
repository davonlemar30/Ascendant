...
5. **Back to the Wing, on your own time.** The Wing keeps giving:
   ...
   - **Practice, and your journal.** Once the wheel has taught you anything, stepping up to it gives you a choice: **Continue the lesson** or **Practice what you know**. Practice asks a few of the things you have learned, spaced further apart each time you remember them. Three misses in one practice and the instrument closes for a moment; you are back in the room, free to read your **journal** (a button in every room) or step straight back up and try again. The journal is a book. Its contents list what you have learned so far, and every sign you have met has its own page, which grows as you learn: its element, then its symbol, its modality, its place on the table, its opposite. It is a crimson binder of ruled loose-leaf pages in the Library's hand, and each sign's picture starts as a bare line drawing and fills with colour as you practice. A ribbon hangs from each sign's page, longer the further you have climbed, and pulled up out of the book when that sign is ready for practice. Reading it proves nothing; the wheel does that.
